...
module.exports = {
    insertDataToDataLog: (
        device_id, msgData) => {
            ...
            // Get the numeric value of WiFi strength (default to null if not found)
            ...
            /* {
                return `INSERT INTO master_catalog.devicecurrentsetting_log ("deviceId", ec, ph, waterr_temp,
                light_on_off_layers, light_Intensity, ambient_temperature, ambient_humidity, water_flow_rate,
                supp_ph_inc_lev, supp_ph_dec_lev, supp_ec_a_lev, supp_ec_b_lev, "hasAlarm", created_timestamp, water_level_indicator, irrigation_pump, chiller_pump, wifi_strength, actual_water_level
                VALUES ('${device_id}', ${msgData.water_ec}, ${msgData.water_pH}, ${msgData.water_temperature},
                '${msgData.light_stat}', ${msgData.light_brightness}, ${msgData.ambient_temp}, ${msgData.ambient_humid},
                ${msgData.water_flow}, ${msgData.supp_ph_inc}, ${msgData.supp_ph_dec}, ${msgData.supp_ec_a}, ${msgData.supp_ec_b},
                ${msgData.error}, '${getDate(msgData.timestamp)}', ${!Boolean(Number(msgData.water_level))}, ${msgData.irrigation_state}, ${msgData.chiller_state}, ${msgData.wifi_strength}, ${msgData.ultrasonic})`
            }, 
{
        return `INSERT INTO master_catalog.devicecurrentsetting_log ("deviceId", ec, ph, waterr_temp,
        light_on_off_layers, light_Intensity, ambient_temperature, ambient_humidity, water_flow_rate,
        supp_ph_inc_lev, supp_ph_dec_lev, supp_ec_a_lev, supp_ec_b_lev, "hasAlarm", created_timestamp, water_level_indicator)
        VALUES ('${device_id}', ${msgData.water_ec}, ${msgData.water_pH}, ${msgData.water_temperature},
        '${msgData.light_stat}', ${msgData.light_brightness}, ${msgData.ambient_temp}, ${msgData.ambient_humid},
        ${msgData.water_flow}, ${msgData.supp_ph_inc}, ${msgData.supp_ph_dec}, ${msgData.supp_ec_a}, ${msgData.supp_ec_b},
        ${msgData.error}, '${getDate(msgData.timestamp)}', ${msgData.water_level})`
    }, */
    ...
    updateDataToRecentData: (
        device_id, msgData) => /* {
                ...
                created_timestamp='${getDate(msgData.timestamp)}', water_level_indicator=${!Boolean(Number(msgData.water_level))}, irrigation_pump=${msgData.irrigation_state}, chiller_pump=${msgData.chiller_state}, wifi_strength=${msgData.wifi_strength}, actual_water_level=${msgData.ultrasonic},`
            ...
            }, */
 {
        ...
        ambient_humidity=${msgData.ambient_humid}, water_flow_rate=${msgData.water_flow}, supp_ph_inc_lev=${msgData.supp_ph_inc},
        supp_ph_dec_lev=${msgData.supp_ph_dec}, supp_ec_a_lev=${msgData.supp_ec_a}, supp_ec_b_lev=${msgData.supp_ec_b}, "hasAlarm"=${msgData.error},
        created_timestamp='${getDate(msgData.timestamp)}', water_level_indicator=${msgData.water_level},`
        if (Number(msgData.irrigation_state)) {
            q += "water_air_pump_on_duration=1, water_air_pump_off_duration=NULL";
        } else {
            q += "water_air_pump_on_duration=NULL, water_air_pump_off_duration=1";
    ...
    insertToAlarmLog: (device_id, msgData) => {
        ...
        return `INSERT INTO master_catalog.devicealarm_log
            (water_pump, water_chiller, water_temperature_sensor, ambient_sensor, ph_sensor, ec_sensor,
            supp_ec_pump, supp_ph_inc_pump, supp_ph_dec_pump, deviceid, created_timestamp,transpiration_error)
            VALUES(${msgData.water_pump}, ${msgData.water_chiller}, ${msgData.water_temperature_sensor},
            ${msgData.ambient_sensor}, ${msgData.ph_sensor}, ${msgData.ec_sensor}, ${msgData.supp_ec_pump},
            ${msgData.supp_ph_inc_pump}, ${msgData.supp_ph_dec_pump}, '${device_id}', '${getDate(msgData.timestamp)}',${msgData.transpiration_error || '0'})`
    }, */
