...
class MaintenanceEvents:
    ...
    def flush_pump(self, state):
        return self.peripheral.flush_pump + self.state_code(state)

    def topup_pump(self, state):
        return self.peripheral.topup_pump + self.state_code(state)
...
class Peripherals:
    def __init__(self):
        ...
        self.flush_pump = "flush_pump"
        self.topup_pump = "topup_pump"
    ...
    def getCode(self, peripheral):
        if peripheral == self.water_pump:
            ...
            return 6
        elif peripheral == self.flush_pump:
            return 7
        elif peripheral == self.topup_pump:
            return 8
