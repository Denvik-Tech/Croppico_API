...
module.exports = {
    insertDataToDataLog: (
        ...
        ${msgData.error}, '${getDate(msgData.timestamp)}', ${!Boolean(Number(msgData.water_level))})`
    },
    ...
    updateDataToRecentData: (
        ...
        created_timestamp='${getDate(msgData.timestamp)}', water_level_indicator=${!Boolean(Number(msgData.water_level))},`
